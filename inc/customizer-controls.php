...
class Colelawson_Customize_Repeatable_Control extends WP_Customize_Control{
	/**
            ...
            <div class="widget">
                <div class="widget-top">
                    ...
                    <div class="widget-title">
                        <h4 class="live-title"><?php _e( 'Item', 'colelawson' ); ?></h4>
                    </div>
                </div>
 ...
 */
function colelawson_sanitize_repeatable_data_field( $input , $setting ){
