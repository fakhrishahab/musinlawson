...
class Colelawson_Service_Widget extends WP_Widget{
	function __construct(){
		parent::__construct(
	        ...
	        // widget options
	        array (
	            'description' => __( 'Identifies where the current page is in the site structure and displays a list of pages in the same section of the site. Only works on Pages.', 'colelawson' )
	        )
